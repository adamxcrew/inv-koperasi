            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        <h2 class="p-4 text-gray-900 border-bottom-info"><?= _app('name'); ?></h2>
                        <!-- Nested Row within Card Body -->
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block text-center mt-1">
                                <img src="<?=base_url('/uploads/');?><?=_app('logo');?>" alt="Login Image" height="350">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
