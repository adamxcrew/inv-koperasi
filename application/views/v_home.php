        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light topbar mb-4 static-top shadow"
                    ...
                    <h1 style="color:white;" class="d-none d-sm-block"><?= _app('name'); ?></h1>
                ...
                <div class="container-fluid">
                    <div class="text-center  d-none d-sm-block">
                        <img src="<?=base_url('/uploads/');?><?=_app('logo');?>" alt="Home" height="640">
                    </div>
                    <div class="text-center d-sm-none">
                        <img src="<?=base_url('/uploads/');?><?=_app('logo');?>" alt="Gambar Mobile" height="340"
                            width="100%">
                    </div>
                </div>
                <!-- /.container-fluid -->
